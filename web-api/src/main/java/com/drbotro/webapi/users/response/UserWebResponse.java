...
public class UserWebResponse extends AbstractModelBean{
    ...
    private UserWebResponse(Builder builder){
        this.id = builder.id;
    ...
    public boolean equals(Object obj){
        ...
        if(obj instanceof UserWebResponse){
            final UserWebResponse other = (UserWebResponse) obj;
    ...
    public static final class Builder{
        ...
        public UserWebResponse build(){
            return new UserWebResponse(this);
        }
